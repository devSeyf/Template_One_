...
<body>
  ...
  <header>
    <div class="container">
      <img src="Images/logo.png" decoding="async" class="logo" alt="">
      <button id="toggle-theme">Click</button>
  ...
  <!-- End Landing Section -->
  <!-- Start Features -->
  <div class="features spaced-padding">
    <div class="container grid-cn ">
      <div class="feat">
  ...
  <div class="services" id="services">
    <div class="container">
      ...
      <div class="services-content grid-cn">
        <div class="col">
          <!-- Start Service -->
          <div class="srv">
  ...
  <div class="portfolio spaced-padding" id="portfolio">
    <div class="container">
      ...
      <div class="portfolio-content grid-cn">
        <div class="card">
  ...
  <!-- End Portfolio -->
  <!-- Start About -->
  <div class="about spaced-padding" id="about">
    <div class="container">
